...
namespace MoviesAPI.Endpoints
{
    public static class MoviesEnpoints
    {
        ...
        {
            var group = app.MapGroup("movies").WithParameterValidation(); //WithParameterValidation() (from a NuGet Package called "MinimalApis.Extension": helps validates the parameters passed to movies in POST method
